 ...
 * @author edima
 */
class SearchOperation implements Operation<SRUSearchRetrieveRequest, SRUSearchRetrieveResponse>, SRUCallback<SRUSearchRetrieveRequest, SRUSearchRetrieveResponse> {
