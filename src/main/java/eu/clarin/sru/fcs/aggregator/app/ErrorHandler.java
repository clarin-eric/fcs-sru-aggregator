 ...
 * Therefore, whenever a 404 pops up in the server, it probably means
 * that the URL should be handled by javascript, and to do that we must
 * return the normal index.html HTML code.
 *
...
public class ErrorHandler extends org.eclipse.jetty.server.handler.ErrorHandler {
    ...
    void forward(final String target, final Request baseRequest, HttpServletRequest request,
