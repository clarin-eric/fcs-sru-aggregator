...
public class SRUSearchThreadedSAVED {

    private static volatile SRUSearchThreadedSAVED instance = null;
    ...
    private SRUSearchThreadedSAVED() {
    ...
    public static SRUSearchThreadedSAVED getInstance() {
        if (instance == null) {
            synchronized (SRUSearchThreadedSAVED.class) {
                if (instance == null) {
                    instance = new SRUSearchThreadedSAVED();
                }
            }
        }
        return instance;
